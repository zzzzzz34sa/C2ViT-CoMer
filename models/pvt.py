...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        self.backbone = pvt_v3_b5()  # [64, 128, 320, 512]pvt_v3_b5 pvt_v2_b2
        ...
        self.linear1 =nn.Linear(131072,2)
...
class PolypPVT_Relative(nn.Module):
    def __init__(self, channel=32):
        super(PolypPVT_Relative, self).__init__()

        self.backbone = pvt_v3_b5()  # [64, 128, 320, 512]
